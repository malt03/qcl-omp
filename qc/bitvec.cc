...
const char* qc_check_txt     = "QCLIB: qc_check failed on condition ";
const char* qc_check_stdmsg  = 
  "Can't continue. Provoking segfault to simplify backtracking.\n";
const char* qc_check_msg  = qc_check_stdmsg;

const char* qc_delete_txt    = "QCLIB: qc_delete warning";
const char* qc_delarray_txt  = "QCLIB: qc_delarray warning";
const char* qc_del_msg =
